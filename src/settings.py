...
# The cloudbrain logs directory. Do not include a trailing slash.
LOG_PATH = '/var/log/cloudbrain'

# The cloudbrain pids directory. Do not include a trailing slash.
PID_PATH = '/var/run/cloudbrain'
...
# empty string. If you comment this out, cloudbrain won't work! Speed improvements
...
# This is the location the cloudbrain agent will write the anomalies file to disk.
...
# in cloudbrain. The Listener will check to see if each incoming metrics
